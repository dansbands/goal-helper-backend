...
goals = Goal.create([{ title: "Learn CSS", notes: "Check out Bootstrap", user_id: 1 }, { title: "Learn JavaScript", notes: "Look at WesBos for Vanilla JS Tutorials", user_id: 1 }, {title: "Dig up a new bone", notes: "I think I saw one under the couch...", user_id: 2 }])
